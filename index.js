...
client.on(Events.MessageCreate, async message => {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription("Click a button below to view the full price list for that game.")
        .setColor("#57F287");

    const row = new ActionRowBuilder().addComponents(
        new ButtonBuilder().setCustomId("gag").setLabel("Grow a Garden").setStyle(ButtonStyle.Primary),
        new ButtonBuilder().setCustomId("pvb").setLabel("Plants V Brainrots").setStyle(ButtonStyle.Primary),
        new ButtonBuilder().setCustomId("sab").setLabel("Steal A Brainrot").setStyle(ButtonStyle.Primary),
